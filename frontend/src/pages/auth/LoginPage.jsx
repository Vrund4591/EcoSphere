    ...
    <div className="flex min-h-screen bg-[#F6F5F1]">
      ...
      <div className="flex flex-1 items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <h2 className="font-serif text-[30px] font-medium text-slate-800">Sign in</h2>
          ...
          <div className="mt-6 rounded-[10px] border border-dashed border-slate-300 bg-slate-100 p-3.5">
